...
robot_namespace = os.getenv("ROBOT_NAME")
...
options = {
  ...
  map_frame = "map",
  tracking_frame = "tb3_1/base_scan",
  published_frame = "tb3_1/base_footprint",
  odom_frame = "odom",
...
if (robot_namespace == "tb3_0") then
  options.tracking_frame = "tb3_0/base_scan"
  options.published_frame = "tb3_0/base_footprint"
end
if (robot_namespace == "tb3_1") then
  options.tracking_frame = "tb3_1/base_scan"
  options.published_frame = "tb3_1/base_footprint"
end
if (robot_namespace == "tb3_2") then
  options.tracking_frame = "tb3_2/base_scan"
  options.published_frame = "tb3_2/base_footprint"
end

--MAP_BUILDER.use_trajectory_builder_3d = false -- default false
MAP_BUILDER.use_trajectory_builder_2d = true -- default false

TRAJECTORY_BUILDER_2D.use_imu_data = false --Do NOT use IMU for generation of trajectory
TRAJECTORY_BUILDER_2D.min_range = 0.1 -- Min range of the LIDAR, default 0 
TRAJECTORY_BUILDER_2D.max_range = 8. -- Max range of the LIDAR, default 30
